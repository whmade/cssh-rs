...
class DemoRecorder:
    ...
    def add_host(self, alias: str) -> None:
        ...
        self.focus_daemon()
        self._keystrokes.press_key("backspace", label=None)
    ...
    def _wait_for_sessions(self, expected: int) -> None:
        """Wait until at least ``expected`` scripted-shell sessions signal readiness.
...
def _require_vim() -> None:
    ...
    if found.returncode != 0:
        raise DemoError("the demo needs vim in the scripted bash; Git for Windows ships it")
